...
function customAssign(...objects) {
  return objects.length >= 2 ? Object.assign(...objects) : `Помилка: Має бути передано принаймні два об'єкти.`
...
function customEntries(obj) {
  return obj instanceof Object ? Object.entries(obj) : "Помилка: Аргумент не є об'єктом."
...
function filterObjectsByKey(arr, key) {
  if (!Array.isArray(arr)) {
    ...
    return arr.filter((value) => value.b)
  }
...
function getObjectValuesSum(obj) {
  if (obj instanceof Object) {
   return Object.values(obj).reduce((acum, value) => acum + value, 0)
  } else {
    return 0
  }
...
function convertArrayToObj(arr) {
  if (Array.isArray(arr)) {
    ...
    console.log(`Підкажіть, як тут використати Object.fromEntries()`)
    return obj;
   } else {
     return {}
   }
